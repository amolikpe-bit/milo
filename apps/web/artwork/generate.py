...
class Canvas:
    ...
    def text(self, x, y, text, color, scale=2):
        glyphs={"A":["0110","1001","1001","1111","1001","1001"],"B":["1110","1001","1110","1001","1001","1110"],"C":["0111","1000","1000","1000","1000","0111"],"E":["1111","1000","1110","1000","1000","1111"],"H":["1001","1001","1111","1001","1001","1001"],"I":["111","010","010","010","010","111"],"L":["100","100","100","100","100","111"],"N":["1001","1101","1011","1001","1001","1001"],"O":["0110","1001","1001","1001","1001","0110"],"Q":["0110","1001","1001","1011","0111","0001"],"R":["1110","1001","1110","1010","1001","1001"],"S":["0111","1000","0110","0001","0001","1110"],"T":["11111","00100","00100","00100","00100","00100"],"U":["1001","1001","1001","1001","1001","0110"],".":["0","0","0","0","0","1"],"0":["0110","1001","1011","1101","1001","0110"],"1":["010","110","010","010","010","111"],"2":["0110","1001","0010","0100","1000","1111"],"/":["0001","0010","0010","0100","0100","1000"]}; text=text.upper()
        for ch in text:
            if ch == " ": x += 3*scale; continue
            glyph = glyphs.get(ch, ["1111", "1001", "1011", "1101", "1001", "1111"])
...
if __name__=="__main__":
    ...
    for name in ("hero","detail","collection"):
        render(name); path=os.path.join(out,name+".png"); print(f"{name}.png  {os.path.getsize(path)} bytes  {hashlib.sha256(open(path,'rb').read()).hexdigest()}")
