...
| 2 — real local protocol; M-01–M-03, R1 | PENDING | Contract/platform | No Compact source, compiler output or local network evidence | Docker-capable environment, exact supported image/compiler cohort, real compile/prove/submit/observe and adverse cases |
